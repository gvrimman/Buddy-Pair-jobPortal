...
function CompaniesHead({ setToggleValue }) {
  const [sortValue, setSortValue] = useState({});
  //   const { searchTexts, setClearSearch } = useJobSearchContext();

  const dispatch = useDispatch();

  //   const handleSearchJob = () => {
  //     const data = [searchTexts, sortValue];

  //     dispatch(getFilteredCompanies(data));
  //   };
