    ...
    <div className="mt-5 grid gap-3">
      ...
      {candidate?.jobDetails?.jobTitle ? (
        <div className="px-1 flex gap-4 items-center">
          <div className="w-8 h-8 flex justify-center items-center bg-purple-100 text-purple-500 font-semibold rounded-full">
          ...
          <div className="flex-1">
            ...
            <h3 className="mt-2 text-sm text-purple-500 font-semibold tracking-wide">
              {candidate?.jobDetails?.companyName || "No company name"}
            </h3>
          </div>
          <div className="h-fit px-4 py-1 bg-purple-100 text-sm text-purple-500 font-semibold rounded-full">
