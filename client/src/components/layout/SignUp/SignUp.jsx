	...
	const onSubmit = (data) => {
		...
		setTimeout(() => {
			if (selectedOption === "Fresher") {
				openFresherInfoModal();
			} else if (selectedOption === "Empolyee") {
				openEmployeeInfoModal();
			} else if (selectedOption === "Empolyer") {
				openEmployerInfoModal();
			}
		}, 300);
	};
							...
							<label className="flex w-full cursor-pointer items-center px-3 py-2">
								<ListItemPrefix className="mr-3">
									<Radio
										...
										onChange={() =>
											handleRadioChange("Empolyee")
										}
										checked={selectedOption === "Empolyee"}
									/>
								</ListItemPrefix>
								<Typography
									color="blue-gray"
							...
							<label className="flex w-full cursor-pointer items-center px-3 py-2">
								<ListItemPrefix className="mr-3">
									<Radio
										...
										onChange={() =>
											handleRadioChange("Empolyer")
										}
										checked={selectedOption === "Empolyer"}
									/>
								</ListItemPrefix>
								<Typography
									color="blue-gray"
