  ...
  return (
    <div className="min-h-screen flex flex-wrap justify-center items-center bg-white text-gray-900">
      <div className="order-2 sm:order-1 text-center">
        <h1 className="text-6xl font-extrabold text-purple-500 animate-bounce">
          404
        </h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-block px-6 py-3 bg-purple-500 text-white rounded-lg shadow-lg hover:bg-purple-600 transition-transform transform hover:scale-105"
          >
            Back to Home
          </Link>
        </div>
